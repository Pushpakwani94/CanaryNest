...
export const CompanyPoliciesPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-extrabold text-slate-800 tracking-tight">Company Policies & Handbook</h1>
        <p className="text-xs text-slate-400 font-medium">Read official workplace regulations, leave rules, and code of conduct.</p>
      </div>
